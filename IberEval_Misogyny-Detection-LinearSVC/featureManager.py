# -*- coding: utf-8 -*-
"""
Created on Wed Dec  6 20:35:19 2017
...
class featureManager(object):
    ...
    def create_feature_space(self,tweets, train_tweets, featureset=None):
            ...
            global_featureset={
                ...
                #"pronounCount" : self.sentimentScore(tweets,train_tweets),
    ...
    def getMentionCount(self, tweets, train_tweets):
        ...
        for tweet in tweets:
            feature.append(len(re.findall("\@", tweet)))

        if train_tweets!=None:
            feature_train  = []
            for tweet in train_tweets:
                feature_train.append(len(re.findall("\@", tweet)))
